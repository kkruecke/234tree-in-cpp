...
--*/
template<class Key, class Value> inline std::tuple<bool, const typename tree234<Key, Value>::Node *, int> tree234<Key, Value>::Node::SearchNode(Key lhs_key) const noexcept 
{
  for(auto i = 0; i < totalItems; ++i) {
