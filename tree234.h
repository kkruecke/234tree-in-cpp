 ...
 * 
 */
template<typename Key, typename Value> inline int tree234<Key, Value>::convert2Node(Node *pnode, int child_index)  noexcept
{   
 ...
 * returns: child_index, which is not changed at all. 
 *
 */
